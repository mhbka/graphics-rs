...
fn main() {
    ...
    let up = Vec3::Y;
    let light_source = Vec3::new(3.0, 3.0, 0.0);
    
    let obj_faces = parse_obj("assets/african_head/african_head.obj");
    let texture_image: Image<RGB> = convert_from_tinytga("assets/african_head/grid.tga");
    let normal_image: Image<RGB> = convert_from_tinytga("assets/african_head/african_head_nm.tga");
    let tangent_normal_image: Image<RGB> = convert_from_tinytga("assets/african_head/african_head_nm_tangent.tga");
    let specular_image: Image<Grayscale> = convert_from_tinytga("assets/african_head/african_head_spec.tga");
